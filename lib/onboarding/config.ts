...
export const SPECIALIZZAZIONI: Record<string, { value: string; label: string }[]> = {
  ...
  'ingegnere_calcoli_strutturali': [
    { value: 'cemento_armato', label: 'Strutture in c.a.' },
    { value: 'acciaio', label: 'Strutture in acciaio' },
    { value: 'legno', label: 'Strutture in legno' },
    { value: 'geotecnica', label: 'Geotecnica e fondazioni' },
    { value: 'sismica', label: 'Analisi sismica' },
    { value: 'industriale', label: 'Strutture industriali' },
  ],
  'ingegnere_pratiche_edilizie': [
    { value: 'nuova_costruzione', label: 'Nuova costruzione' },
    { value: 'ristrutturazione', label: 'Ristrutturazione e ampliamento' },
    { value: 'sanatoria', label: 'Sanatorie e condono' },
    { value: 'agibilita', label: 'Certificato di agibilità' },
    { value: 'variante', label: 'Varianti in corso d\'opera' },
  ],
  'ingegnere_collaudi': [
    { value: 'strutturale', label: 'Collaudo statico' },
    { value: 'impianti', label: 'Collaudo impianti' },
    { value: 'antincendio', label: 'Prevenzione incendi (VV.FF.)' },
    { value: 'energetico', label: 'APE e prestazioni energetiche' },
    { value: 'sicurezza', label: 'Verifica sicurezza (D.Lgs. 81/2008)' },
  ],
  'ingegnere_capitolati': [
    { value: 'opere_civili', label: 'Opere civili' },
    { value: 'impianti', label: 'Impianti meccanici ed elettrici' },
    { value: 'forniture', label: 'Forniture e materiali' },
    { value: 'manutenzione', label: 'Manutenzione e gestione' },
  ],
...
export const FONTI_DEFAULT: Record<string, Fonte[]> = {
  ...
  'ingegnere_calcoli_strutturali': [
    { id: 'ntc2018', label: 'NTC 2018', descrizione: 'Norme Tecniche per le Costruzioni' },
    { id: 'eurocodici', label: 'Eurocodici (EC 0–8)', descrizione: 'Standard strutturali europei' },
    { id: 'circolare_2019', label: 'Circolare NTC n. 7/2019', descrizione: 'Istruzioni applicative NTC 2018' },
    { id: 'uni_norme', label: 'Norme UNI', descrizione: 'Standard tecnici italiani' },
    { id: 'dottrina_tecnica', label: 'Letteratura tecnica strutturale', descrizione: 'Manuali e trattati di ingegneria' },
  ],
  'ingegnere_pratiche_edilizie': [
    { id: 'dpr_380', label: 'D.P.R. 380/2001', descrizione: 'Testo Unico Edilizia' },
    { id: 'prg_pgt', label: 'PRG / PGT comunale', descrizione: 'Piano regolatore / Piano di governo del territorio' },
    { id: 'codice_civile', label: 'Codice Civile', descrizione: 'Luci, vedute, servitù, distanze (artt. 873 ss.)' },
    { id: 'l_47_85', label: 'L. 47/1985 — Condono', descrizione: 'Sanatorie abusi edilizi' },
    { id: 'dpr_139', label: 'D.P.R. 139/2010', descrizione: 'Procedimento semplificato beni paesaggistici' },
  ],
  'ingegnere_collaudi': [
    { id: 'ntc2018_cap9', label: 'NTC 2018 — Cap. 9', descrizione: 'Collaudo statico' },
    { id: 'd_lgs_81', label: 'D.Lgs. 81/2008', descrizione: 'T.U. Sicurezza sul lavoro' },
    { id: 'dpr_151', label: 'D.P.R. 151/2011', descrizione: 'Prevenzione incendi — attività soggette' },
    { id: 'dlgs_192', label: 'D.Lgs. 192/2005', descrizione: 'Prestazioni energetiche — APE' },
    { id: 'uni_cei', label: 'Norme UNI/CEI', descrizione: 'Standard tecnici per collaudi impianti' },
  ],
  'ingegnere_capitolati': [
    { id: 'dlgs_36_2023', label: 'D.Lgs. 36/2023', descrizione: 'Codice dei contratti pubblici' },
    { id: 'uni_norme', label: 'Norme UNI', descrizione: 'Standard tecnici capitolati' },
    { id: 'cam', label: 'CAM — Criteri Ambientali Minimi', descrizione: 'D.M. ambientali per appalti pubblici' },
    { id: 'anac', label: 'Linee guida ANAC', descrizione: 'Autorità Nazionale Anticorruzione' },
  ],
